...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  printURL: (url, options) =>
    ipcRenderer.invoke("print:url", url, options || {}),
  printPreviewCurrent: (options) =>
    ipcRenderer.invoke("print:preview-current", options || {}),
  printPreviewHtml: (html, options) =>
    ipcRenderer.invoke("print:preview-html", html, options || {}),
  printPreviewPdf: (dataUrlOrBase64) =>
    ipcRenderer.invoke("print:preview-pdf", dataUrlOrBase64),
