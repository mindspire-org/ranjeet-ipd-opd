...
export const HospitalIpdDischargeSummary =
  models.Hospital_IpdDischargeSummary ||
  model("Hospital_IpdDischargeSummary", IpdDischargeSummarySchema);
