...
export default function Lab_SupplierReturnDialog({
  open,
  onClose,
  purchase,
  onSubmitted,
  ...
  async function submit() {
    ...
    try {
      ...
      onSubmitted({
        purchase: (res as any)?.purchase || null,
        returnDoc: retDoc,
      });
      try {
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="w-56 rounded-md border border-slate-300 bg-white px-2 py-1 text-sm dark:border-slate-700 dark:bg-slate-950/30 dark:text-slate-100"
              />
