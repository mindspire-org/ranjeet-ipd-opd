      ...
      <div className="w-full max-w-2xl rounded-xl border border-slate-200 bg-white p-5 shadow-lg">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
          ...
          <div>
            ...
            <input value={form.cnic} onChange={e=>update('cnic', e.target.value)} placeholder="CNIC" className="w-full rounded-md border border-slate-300 px-3 py-2 outline-none focus:border-violet-500 focus:ring-2 focus:ring-violet-200" />
          </div>
          <div>
