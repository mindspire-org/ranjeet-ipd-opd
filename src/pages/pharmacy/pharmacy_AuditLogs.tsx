...
export default function Pharmacy_AuditLogs() {
  ...
  const exportPdf = async () => {
    try {
      ...
      showNotice("error", "Failed to generate PDF. Please try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  const exportExcel = async () => {
    try {
      ...
      showNotice("error", "Failed to generate Excel file. Please try again.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border border-slate-200 bg-white p-4">
        <div className="mb-3 flex items-center gap-2 text-slate-700">
          ...
          >
            <path d="M8.25 13.5a2.25 2.25 0 1 1 0-4.5 2.25 2.25 0 0 1 0 4.5ZM3.75 12a4.5 4.5 0 1 0 9 0 4.5 4.5 0 0 0-9 0Z" />
            <path d="M17.25 8.25a2.25 2.25 0 1 1 0 4.5 2.25 2.25 0 0 1 0-4.5Z" />
            <path d="M17.25 15.75a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9Z" />
          </svg>
