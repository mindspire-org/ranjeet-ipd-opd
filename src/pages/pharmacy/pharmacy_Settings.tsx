...
export default function Pharmacy_Settings() {
  ...
  const savePharmacy = async () => {
    try {
      ...
      showNotice("success", "Pharmacy settings saved");
    } catch {
      showNotice("error", "Failed to save pharmacy settings");
    }
  };
  ...
  const saveSystem = () => {
    ...
    showNotice("success", "System settings saved (demo)");
  };
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className={`rounded-md border px-3 py-1.5 text-sm ${activeTab === "pharmacy" ? "border-slate-300 bg-white text-slate-900" : "border-transparent bg-slate-100 text-slate-700 hover:bg-slate-200"}`}
        >
          Pharmacy Settings
        </button>
        <button
          onClick={() => setActiveTab("system")}
          className={`rounded-md border px-3 py-1.5 text-sm ${activeTab === "system" ? "border-slate-300 bg-white text-slate-900" : "border-transparent bg-slate-100 text-slate-700 hover:bg-slate-200"}`}
        >
          System Settings
        </button>
      </div>
        ...
        <div className="rounded-xl border border-slate-200 bg-white">
          ...
          <div className="space-y-4 p-4">
            ...
            <div className="flex items-center justify-end">
              <button onClick={savePharmacy} className="btn">
                Save Settings
              </button>
            </div>
          </div>
      ...
      {activeTab === "system" && (
        <div className="rounded-xl border border-slate-200 bg-white">
          ...
          <div className="space-y-4 p-4">
            ...
            <div className="flex items-center justify-end">
              <button onClick={saveSystem} className="btn">
                Save Settings
              </button>
            </div>
          </div>
