...
export default function Hospital_BedManagement() {
  ...
  const removeRoom = (_id: string) => { alert('Room delete not available'); }
  const removeWard = (_id: string) => { alert('Ward delete not available'); }
  ...
  return (
    <div>
      ...
      <Hospital_ManageRoomsModal open={openManageRooms} onClose={() => setOpenManageRooms(false)} rooms={rooms} floorsMap={floorsMap} onDelete={removeRoom} />

      <Hospital_ManageWardsModal open={openManageWards} onClose={() => setOpenManageWards(false)} wards={wards} floorsMap={floorsMap} onDelete={removeWard} />
