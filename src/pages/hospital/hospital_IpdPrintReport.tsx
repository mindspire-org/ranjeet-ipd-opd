            ...
            <div className="mt-2 grid gap-3 grid-cols-1">
                ...
                <table className="w-full table-fixed text-xs border border-slate-200 rounded-md overflow-hidden">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="text-slate-700">
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.cvs || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.renal || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.respiration || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.hepatic || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.diabetic || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.git || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.neurology || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.anesthesiaHistory || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).existingProblems?.eventful || '-'}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div>
                ...
                <table className="w-full table-fixed text-xs border border-slate-200 rounded-md overflow-hidden">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="text-slate-700">
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.bp || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.pulse || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.rr || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.temp || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.cvs || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.chest || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.teeth || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.mallampatiClass || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).physicalExam?.asaClass || '-'}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div>
                ...
                <table className="w-full table-fixed text-xs border border-slate-200 rounded-md overflow-hidden">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="text-slate-700">
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).plan?.general || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).plan?.spinal || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).plan?.local || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).plan?.monitoringCare || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).plan?.npo || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).plan?.fluidsBlood || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).plan?.preAnesthesiaMedication || '-'}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div>
                ...
                <table className="w-full table-fixed text-xs border border-slate-200 rounded-md overflow-hidden">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="text-slate-700">
                      <td className="px-3 py-1.5 wrap-break-word">{((n.data||{}).checklist?.patientIdentified ? 'Yes' : 'No')}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{((n.data||{}).checklist?.consentRevised ? 'Yes' : 'No')}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{((n.data||{}).checklist?.siteChecked ? 'Yes' : 'No')}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div>
                ...
                <table className="w-full table-fixed text-xs border border-slate-200 rounded-md overflow-hidden">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="text-slate-700">
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).preInduction?.orientation || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).preInduction?.bp || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).preInduction?.pulse || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).preInduction?.temp || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).preInduction?.spo2 || '-'}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
              ...
              <div>
                ...
                <table className="w-full table-fixed text-xs border border-slate-200 rounded-md overflow-hidden">
                  ...
                  <tbody className="divide-y divide-slate-200">
                    <tr className="text-slate-700">
                      <td className="px-3 py-1.5 wrap-break-word">{((n.data||{}).planChange?.changed ? 'Yes' : 'No')}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).planChange?.general || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).planChange?.spinal || '-'}</td>
                      <td className="px-3 py-1.5 wrap-break-word">{(n.data||{}).planChange?.local || '-'}</td>
                    </tr>
                  </tbody>
                </table>
              </div>
